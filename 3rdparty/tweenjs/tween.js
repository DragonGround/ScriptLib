...
var Tween = (function () {
    ...
    Tween.prototype.start = function (time) {
        if (time === void 0) { time = (0, now_1.default)(); }
        if (this._isPlaying) {
            return this;
        }
    ...
    Tween.prototype.group = function (group) {
        if (group === void 0) { group = mainGroup_1.mainGroup; }
        this._group = group;
        return this;
    };
    ...
    Tween.prototype.easing = function (easingFunction) {
        if (easingFunction === void 0) { easingFunction = easing_1.default.Linear.None; }
        this._easingFunction = easingFunction;
        return this;
    };
    Tween.prototype.interpolation = function (interpolationFunction) {
        if (interpolationFunction === void 0) { interpolationFunction = interpolation_1.default.Linear; }

...
var DiamondToggle = function (_a) {
    var classProp = _a.class, children = _a.children, checked = _a.checked, onChange = _a.onChange, style = _a.style;
    return (0, preact_1.h)(exports.Switch, { class: "w-8 h-8 p-[6px] rounded-md border-[1px] ".concat(checked ? 'border-[rgba(255_255_255_0.8)] bg-[rgba(0_0_0_0.5)] rotate-[45deg]' : 'border-[rgba(255_255_255_0.5)] bg-[rgba(0_0_0_0.8)] rotate-0', " transition-[background-color,rotate] duration-200 ").concat(classProp), checked: checked, onChange: onChange, style: style }, function (_a) {
        var checked = _a.checked;

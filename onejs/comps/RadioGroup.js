...
var RadioToggle = function (_a) {
    ...
    return (0, preact_1.h)(exports.RadioGroup, { class: "flex flex-row rounded-md overflow-hidden bg-white/50 ".concat(classProp), index: index, onChange: onChangeIndex }, items.map(function (item, i) { return ((0, preact_1.h)(exports.RadioGroup.Option, { class: function (_a) {
            var checked = _a.checked;
            return "".concat(checked ? "bg-white/70" : "bg-white/0", " p-2 transition-[background-color] duration-200");
        }, index: i }, function (_a) {
        var checked = _a.checked;
